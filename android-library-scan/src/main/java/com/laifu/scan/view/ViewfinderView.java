...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            final String hint = getResources().getString(R.string.scan_text);
            final float leftOffset = (getResources().getDisplayMetrics().widthPixels - getTextWidth(paint, hint)) / 2;
            canvas.drawText(hint, leftOffset, (frame.bottom + (float) TEXT_PADDING_TOP * density), paint);
